...
**Repository settings** include the bookmark naming pattern, files copied into new workspaces, and the default agent and model. When creating a workspace, Advanced also lets you sparse-checkout paths and symlink heavy gitignored directories from the home repo.
